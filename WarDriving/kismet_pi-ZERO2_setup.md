## Kismet Auto-Start Wi-Fi + GPS + Wigle Logging on Kali (Raspberry PI zero 512 mb)



## Hardare

Raspberry PI Zero 2 W (Wireless / Bluteooth) 2021 (RPI Zero 2W) with headers
Waveshare v4 E-ink 2.13 paper hat display
USB to MicroUSB adapter (to burn image to micro sd card)
64 GB micro sd card
USB to micro usb data cable
Panda PAU0F AXE3000 wireless adapter
GPS USB adapter

## Software

Raspberry pi lite headless SSH edition
...
Bluetooth/BLE capture using internal Pi Bluetooth (hci0)
