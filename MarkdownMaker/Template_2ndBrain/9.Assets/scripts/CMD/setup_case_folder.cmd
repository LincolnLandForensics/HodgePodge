...
if not exist "Cases\%caseNumber%_%caseName%\Item" mkdir "Cases\%caseNumber%_%caseName%\Item"
...
REM Check and create the "Image" directory under "Cases\<caseNumber>_<caseName>\Item"
if not exist "Cases\%caseNumber%_%caseName%\Item\Image" mkdir "Cases\%caseNumber%_%caseName%\Item\Image"
...
if not exist "CaseWF\%caseNumber%_%caseName%\Item" mkdir "CaseWF\%caseNumber%_%caseName%\Item"


REM Check and create the "Case" directory under "CaseWF\<caseNumber>_<caseName>\Item"
if not exist "CaseWF\%caseNumber%_%caseName%\Item\Case" mkdir "CaseWF\%caseNumber%_%caseName%\Item\Case"


REM Check and create the "Exports" directory under "CaseWF\<caseNumber>_<caseName>\Item"
if not exist "CaseWF\%caseNumber%_%caseName%\Item\Exports" mkdir "CaseWF\%caseNumber%_%caseName%\Item\Exports"

REM Check and create the "imageCOPY" directory under "CaseWF\<caseNumber>_<caseName>\imageCOPY"
if not exist "CaseWF\%caseNumber%_%caseName%\Item\imageCOPY" mkdir "CaseWF\%caseNumber%_%caseName%\Item\imageCOPY"
